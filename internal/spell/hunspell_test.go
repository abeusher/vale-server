...
var hunspellUnsupported = map[string]string{
	"2970240":                    "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"2970242":                    "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"compoundaffix":              "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"compoundaffix3":             "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"compoundforbid":             "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"fogemorpheme":               "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	...
	"onlyincompound":             "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"onlyincompound2":            "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"onlyincompound3":            "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"opentaal_forbiddenword1":    "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"opentaal_forbiddenword2":    "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"trace_compound":             "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"wordpair":                   "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"forceucase":                 "compound position flags (COMPOUNDBEGIN/MIDDLE/END, COMPOUNDPERMITFLAG, COMPOUNDFORBIDFLAG)",
	"checkcompoundpattern":       "CHECKCOMPOUNDPATTERN",
	"checkcompoundpattern2":      "CHECKCOMPOUNDPATTERN",
	"checkcompoundpattern3":      "CHECKCOMPOUNDPATTERN",
	"checkcompoundpattern4":      "CHECKCOMPOUNDPATTERN",
	"checkcompoundpattern5":      "CHECKCOMPOUNDPATTERN",
	"checkcompoundpattern6":      "CHECKCOMPOUNDPATTERN",
	"checkcompoundpattern7":      "CHECKCOMPOUNDPATTERN",
	"opentaal_cpdpat":            "CHECKCOMPOUNDPATTERN",
	"opentaal_cpdpat2":           "CHECKCOMPOUNDPATTERN",
	"checkcompoundcase":          "CHECKCOMPOUNDCASE",
	"checkcompoundcase2":         "CHECKCOMPOUNDCASE",
	"checkcompoundcaseutf":       "CHECKCOMPOUNDCASE",
	"checkcompounddup":           "CHECKCOMPOUNDDUP",
	"checkcompoundrep":           "CHECKCOMPOUNDREP",
	"checkcompoundrep2":          "CHECKCOMPOUNDREP",
	"checkcompoundtriple":        "CHECKCOMPOUNDTRIPLE and SIMPLIFIEDTRIPLE",
	"simplifiedtriple":           "CHECKCOMPOUNDTRIPLE and SIMPLIFIEDTRIPLE",
	...
	"allcaps":                    "case model: all-caps of mixed-case and apostrophe words, trailing periods",
	"allcaps2":                   "case model: all-caps of mixed-case and apostrophe words, trailing periods",
	"allcaps_utf":                "case model: all-caps of mixed-case and apostrophe words, trailing periods",
	"base":                       "case model: all-caps of mixed-case and apostrophe words, trailing periods",
	"base_utf":                   "case model: all-caps of mixed-case and apostrophe words, trailing periods",
	"IJ":                         "case model: all-caps of mixed-case and apostrophe words, trailing periods",
	"gh106":                      "case model: all-caps of mixed-case and apostrophe words, trailing periods",
	"i58202":                     "case model: all-caps of mixed-case and apostrophe words, trailing periods",
	"opentaal_keepcase":          "case model: all-caps of mixed-case and apostrophe words, trailing periods",
	"checksharps":                "CHECKSHARPS",
	"checksharpsutf":             "CHECKSHARPS",
	"checksharpsutf2":            "CHECKSHARPS",
	"dotless_i":                  "Turkish dotless i in case folding",
	"forbiddenword":              "FORBIDDENWORD against case variants",
	"ph2":                        "FORBIDDENWORD against case variants",
	"break":                      "BREAK at word edges and on repeated patterns",
	"breakdefault":               "BREAK at word edges and on repeated patterns",
	...
	"fullstrip":                  "FULLSTRIP",
	"gh1044":                     "FULLSTRIP",
	"zeroaffix":                  "zero-length affix with a strip",
